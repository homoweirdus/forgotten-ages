...
{
	public class DruidBlade : ModProjectile
	{
		int timer = 0;
		...
		public override void AI()
		{
			...
			{
				Dust dust = Main.dust[Dust.NewDust(projectile.position + projectile.velocity, projectile.height, projectile.width, 163, 0f, 0f)];
				dust.noGravity = true;
			}
			
			if (projectile.ai[0] > 0 || projectile.ai[1] > 60)
			{
				projectile.alpha += 10;
			}
