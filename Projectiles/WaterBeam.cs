...
{
	public class WaterBeam : ModProjectile
	{
			...
			if ((double) projectile.ai[0] > 3.0)
			{
				for (int index1 = 0; index1 < 1; ++index1)
				{
					for (int index2 = 0; index2 < 3; ++index2)
					{
						...
						int num3 = 6;
						int index3 = Dust.NewDust(new Vector2((float) projectile.position.X + (float) num3, (float) projectile.position.Y + (float) num3), projectile.width - num3 * 2, projectile.height - num3 * 2, 172, 0.0f, 0.0f, 100, new Color(), 1.2f);
					...
					{
						int num = 6;
						int index2 = Dust.NewDust(new Vector2((float) projectile.position.X + (float) num, (float) projectile.position.Y + (float) num), projectile.width - num * 2, projectile.height - num * 2, 172, 0.0f, 0.0f, 100, new Color(), 0.75f);
