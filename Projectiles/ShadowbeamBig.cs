...
{
	public class ShadowbeamBig : ModProjectile
	{
		int kek;
		...
		public override void AI()
		{
			...
			if (Main.projectile[(int)projectile.ai[1]].active && Main.projectile[(int)projectile.ai[1]].type == mod.ProjectileType("VoidboltStaff"))
			{
			...
			for (int num818 = 0; num818 < 2; num818 = num3 + 1)
			{
				...
				int num821 = Dust.NewDust(vector82, 0, 0, 173, vector83.X, vector83.Y, 0, default(Color), 1f);
				Main.dust[num821].noGravity = true;
				Main.dust[num821].scale = 1.2f;
				Main.dust[num821].velocity *= 2;
				num3 = num818;
			}
			if (Main.rand.Next(5) == 0)
			{
				...
				int num822 = Dust.NewDust(vector82 + value31 - Vector2.One * 4f, 8, 8, 173, 0f, 0f, 100, default(Color), 1.5f);
