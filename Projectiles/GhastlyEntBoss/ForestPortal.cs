        ...
        public override void AI()
        {
			...
			if (projectile.scale == 1f)
			{
				...
				if (counter2 >= 30)
				{
					...
					Vector2 v = (Main.player[closest].Center - projectile.Center);
					v.Normalize();
					v *= 16;
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, v.X, v.Y, mod.ProjectileType("GiantLeaf"), projectile.damage, 5f, projectile.owner);
					counter2 = 0;
				}
			}
        }
