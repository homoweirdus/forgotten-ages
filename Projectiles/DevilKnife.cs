...
namespace ForgottenMemories.Projectiles
{
	public class DevilKnife : ModProjectile
	{
		...
		public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("GlowMasks/DevilKnifeMask"), projectile.position + projectile.Size / 2f - Main.screenPosition + new Vector2(0f, 0f), new Microsoft.Xna.Framework.Rectangle?(rectangle), Color.White, projectile.rotation, origin2, projectile.scale, SpriteEffects.None, 0f);
		}
