...
{
	public class forbiddenboom : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Desert Explosion");
		}
		public override bool PreAI()
		{
				...
				int dust2 = Dust.NewDust(projectile.position + vector2, 0, 0, 57, newVect2.X, newVect2.Y);
				int dust3 = Dust.NewDust(projectile.position + vector2, 0, 0, 32, newVect3.X, newVect3.Y);
				int dust4 = Dust.NewDust(projectile.position + vector2, 0, 0, 57, newVect4.X, newVect4.Y);
				int dust5 = Dust.NewDust(projectile.position + vector2, 0, 0, 32, newVect5.X, newVect5.Y);
				int dust6 = Dust.NewDust(projectile.position + vector2, 0, 0, 57, newVect6.X, newVect6.Y);
				int dust7 = Dust.NewDust(projectile.position + vector2, 0, 0, 32, newVect7.X, newVect7.Y);
				int dust8 = Dust.NewDust(projectile.position + vector2, 0, 0, 57, newVect8.X, newVect8.Y);
