...
{
	public class SeveredTongue : ModProjectile
	{
		int index1 = -1;
		int TrailCounter = 0;
		float rotate;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (flag)
			{
				...
				else
				{
					...
					Main.spriteBatch.Draw(mod.GetTexture("Projectiles/Chain/TongueChain"), new Vector2(vector2.X - Main.screenPosition.X, vector2.Y - Main.screenPosition.Y), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, 0, 10, 16)), color, rotation, new Vector2((float) 10 * 0.5f, (float) 16 * 0.5f), 1f, SpriteEffects.None, 0.0f);
				}
			}
			return true;
		}
