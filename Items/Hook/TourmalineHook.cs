...
namespace ForgottenMemories.Items.Hook
{
	class TourmalineHook : ModItem
	{
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "Tourmaline", 15);
            recipe.AddTile(16);
	...
	class TourmalineProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				spriteBatch.Draw(mod.GetTexture("Items/Hook/TourmalineChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
