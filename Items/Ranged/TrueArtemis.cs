...
namespace ForgottenMemories.Items.Ranged
{
    public class TrueArtemis : ModItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
				...
				Projectile.NewProjectile(position.X, position.Y, newVect.X, newVect.Y, mod.ProjectileType("CursedLightning"), damage, knockBack, player.whoAmI, 0, 0);
				Projectile.NewProjectile(position.X, position.Y, newVect2.X, newVect2.Y, mod.ProjectileType("CursedLightning"), damage, knockBack, player.whoAmI, 0, 0);
				Projectile.NewProjectile(position.X, position.Y, newVect3.X, newVect3.Y, mod.ProjectileType("CursedLightning"), damage, knockBack, player.whoAmI, 0, 0);
				Projectile.NewProjectile(position.X, position.Y, newVect4.X, newVect4.Y, mod.ProjectileType("CursedLightning"), damage, knockBack, player.whoAmI, 0, 0);
            return false;
        }
