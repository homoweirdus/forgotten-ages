...
{
    public class BombBlocksOnlyItem : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Bomb - Blocks Only"; //the name displayed when hovering over the item ingame.
            item.damage = 0;     //The damage stat for the Weapon.
            item.toolTip = "These bombs only destroy blocks, not walls"; //The description of the item shown when hovering over the item ingame.                    
            ...
            item.shoot = mod.ProjectileType("BombBlocksOnly"); //This defines what type of projectile this item will shoot
