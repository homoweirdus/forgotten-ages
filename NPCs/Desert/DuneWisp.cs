	...
	public class DuneWisp : ModNPC
	{
		...
		public override void AI()
		{
			...
			if (npc.ai[0] < 180)
			{
				...
				int index = Dust.NewDust(npc.position, npc.width, npc.height, 32, 0.0f, 0.0f, 0, new Color(), 0.75f);
		...
		public override void NPCLoot()
		{
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("BossEnergy"), Main.rand.Next(5, 7));
		}
	}
}
