...
namespace ForgottenMemories.NPCs.Beach
{
	public class PalmTreeMan : ModNPC
	{
		...
		{
			DisplayName.SetDefault("Palm Tree Man");
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return !Main.bloodMoon && NPC.downedBoss1 && spawnInfo.player.ZoneBeach && (tile == 60) && spawnInfo.spawnTileY < Main.rockLayer && !Main.dayTime ? 0.1f : 0f;
		}
